            ...
            <article className="prose prose-lg max-w-none">
              ...
              <Card className="p-6 mb-8 bg-muted/50">
                <p className="text-lg font-medium mb-0">
                  AI không chỉ thay đổi cách chúng ta làm việc, mà còn thay đổi
                  bản chất của lao động ở cấp độ sâu xa.
                </p>
              </Card>
              ...
              <p>Máy móc thay thế một phần lao động chân tay:</p>
              <ul className="space-y-2">
              ...
              <Card className="p-6 my-6 bg-primary/5 border-primary/20">
                <ul className="space-y-3 mb-0">
                  <li>
                    <strong>Lao động chân tay:</strong> Tự động hóa bởi robot
                  </li>
                  <li>
                    <strong>Lao động nhận thức:</strong> Được hỗ trợ/thay thế
                    bởi AI (phân tích dữ liệu, dự đoán, ra quyết định)
                  </li>
                  <li>
                    <strong>Lao động sáng tạo:</strong> Vẫn cần con người (nghệ
                    thuật, chiến lược, đổi mới)
                  </li>
                </ul>
              </Card>
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3">
                a) Chiết xuất giá trị thặng dư mới
              </h3>
              <p>
                Khi AI thay thế lao động truyền thống, tư bản phải tìm nguồn giá
                trị mới:
              </p>
              ...
              <Card className="p-6 my-6 bg-accent/10 border-accent/20">
                ...
                <p className="mb-3">
                  Người dùng tạo ra dữ liệu (lao động không được trả công) →
                  Công ty công nghệ khai thác → Tạo ra giá trị thặng dư
                </p>
              ...
              <Card className="p-6 my-6 bg-accent/10 border-accent/20">
                <h4 className="font-semibold mb-3">
                  2. Lao động gig (gig economy):
                </h4>
                <p className="mb-3">
                  Nền tảng số kết nối người lao động với khách hàng → Chiết xuất
                  giá trị thặng dư từ mỗi giao dịch
                </p>
                <p className="text-sm italic mb-0">
                  Ví dụ: Uber, Grab, Fiverr – người lao động không phải nhân
                  viên chính thức
                </p>
              </Card>
              ...
              <Card className="p-6 my-6 bg-accent/10 border-accent/20">
                <h4 className="font-semibold mb-3">
                  3. Lao động trí tuệ cao cấp:
                </h4>
                <p className="mb-0">
                  Kỹ sư AI, nhà khoa học dữ liệu, designer UX → Vẫn tạo ra giá
                  trị thặng dư qua lao động sáng tạo
                </p>
              </Card>

              <h3 className="text-xl font-semibold mt-6 mb-3">
                b) Tầng lớp lao động mới
              </h3>
              <p>AI tạo ra sự phân hóa sâu sắc trong giai cấp lao động:</p>

              <ul className="space-y-2">
                <li>
                  <strong>Lao động kỹ thuật cao:</strong> Kỹ sư AI, chuyên gia
                  dữ liệu (lương cao, điều kiện tốt)
                </li>
                <li>
                  <strong>Lao động gig:</strong> Tài xế Grab, shipper (thu nhập
                  bấp bênh, không bảo hiểm)
                </li>
                <li>
                  <strong>Lao động thất nghiệp:</strong> Những người bị AI thay
                  thế (nguy cơ cao nhất)
                </li>
              </ul>
              ...
              <Card className="p-6 my-6 bg-destructive/10 border-destructive/20">
                ...
                <ul className="space-y-2 mb-0">
                  ...
                  <li>
                    • <strong>Lao động:</strong> Cung cấp dữ liệu và sức lao
              ...
              <ul className="space-y-2">
                ...
                <li>
                  • Con người tập trung vào sáng tạo, nghệ thuật, chăm sóc lẫn
                  nhau
                </li>
                <li>
                  • Xã hội áp dụng thuế AI, thu nhập cơ bản phổ quát (UBI)
                </li>
              </ul>
              ...
              <Card className="p-6 my-6 bg-primary/5 border-primary/20">
                ...
                <p className="mb-0">
                  ...
                  thuộc vào <strong>các quyết định chính trị và xã hội</strong>{" "}
                  mà chúng ta đưa ra hôm nay.
                </p>
              </Card>
