          ...
          <div className="max-w-5xl mx-auto animate-fade-in">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-blue-100/80">
                Tổng kết về mối quan hệ giữa Con người, Lao động và Trí tuệ nhân
                tạo
              </p>
            </div>
            ...
            <Card className="presentation-card backdrop-blur-lg shadow-2xl border-blue-500/30">
              <CardContent className="p-10 md:p-14 space-y-8 text-justify leading-relaxed text-blue-100/90">
                <p className="text-lg">
                  ...
                  Chỉ <span className="font-bold text-accent">con người</span>{" "}
                ...
                <div className="mt-16 text-center">
                  <p className="text-lg text-blue-200">
                    <span className="font-semibold text-accent">AI</span> không
